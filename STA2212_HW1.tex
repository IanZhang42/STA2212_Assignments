...
\begin{equation*}
  \ell(\mu_1,\ldots, \mu_n, \sigma^2 \mid x_1,\ldots, x_n, y_1,\ldots, y_n) \propto -2n\log\sigma - \sum_{i=1}^n \frac{1}{2\sigma^2} ((x_i - \mu_i)^2 + (y_i - \mu_i)^2)
\end{equation*} 
For each $i$, 
\begin{equation*}
...
\begin{equation*}
  \frac{\partial \ell}{\partial \sigma} = -\frac{2n}{\sigma} + \frac{1}{\sigma^3}\sum_{i=1}^n ((x_i - \mu_i)^2 + (y_i - \mu_i)^2)
\end{equation*}
Setting this to 0 yields the MLE 
\begin{equation*}
  \hat\sigma^2 = \frac{1}{2n}\sum_{i=1}^n [(X_i - \hat\mu_i)^2 + (Y_i - \hat \mu_i)^2] = \frac{1}{4n} \sum_{i=1}^n (X_i - Y_i)^2
\end{equation*}
Let $Z_i = X_i - Y_i$, so the $Z_i$ are i.i.d. $\mathcal N(0, 2\sigma^2)$. Then by the WLLN and continuous mapping theorem, 
\begin{equation*}
  \hat\sigma^2 = \frac{1}{4n} \sum_{i=1}^n Z_i^2 \stackrel{p}{\to} \frac{1}{4}(E(Z_1^2)) = \frac{1}{2} (0 + 2\sigma^2) = \frac{1}{2}\sigma^2
\end{equation*}
as required. \\
(d) Since the $Z_i$ are i.i.d. $\mathcal N(0, 2\sigma^2)$, the log-likelihood function of $\sigma$ is given by 
\begin{equation*}
  \ell (\sigma \mid z_1,\ldots, z_n) \propto -n \log \sigma - \sum_{i=1}^n \frac{1}{4\sigma^2}z_i^2
\end{equation*}
thus the partial derivative of $\ell$ with respects to $\sigma$ is 
\begin{equation*}
  \frac{\partial \ell}{\partial \sigma} = -\frac{n}{\sigma} + \frac{1}{2\sigma^3} \sum_{i=1}^n z_i^2
\end{equation*}
Setting the above to 0 yields the MLE 
\begin{equation*}
  \hat\sigma^2 = \frac{1}{2n}\sum_{i=1}^n Z_i^2 = \frac{1}{2n}\sum_{i=1}^n (X_i - Y_i)^2
\end{equation*}
To show consistency, we use the WLLN and continuous mapping theorem again: 
\begin{equation*}
  \hat\sigma^2 = \frac{1}{2n}\sum_{i=1}^n Z_i^2 = \frac{1}{2}\overline{Z^2} \stackrel{p}{\to} \frac{1}{2}E(Z_1^2) = \sigma^2
\end{equation*}
as required. 
}
