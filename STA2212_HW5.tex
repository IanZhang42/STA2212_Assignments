...
\begin{equation*}
    w = \begin{cases}
        ...
        \bar x_1^2 & \bar x_1 > 0, \bar x_2 \leq 0\\
        \bar x_2^2 & \bar x_1 \leq 0, \bar x_2 > 0\\
        \bar x_1^2 + \bar x_2 & \bar x_1 > 0, \bar x_2 > 0
    \end{cases}
\end{equation*}
...
\begin{align*}
    ...
    P(w = \bar X_1^2) &= P(\bar X_1 > 0, \bar X_2 \leq 0) = \frac 14\\
    P(w = \bar X_2^2) &= P(\bar X_1 \leq 0, \bar X_2 > 0) = \frac 14\\
    P(w = \bar X_1^2 + \bar X_2^2) &= P(\bar X_1 > 0, \bar X_2 > 0) = \frac 14
\end{align*}
